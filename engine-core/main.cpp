...
#include "src/graphics/GameManager.h"
...
int main()
{
	...
	g->addEntity(new Entity(vec3(1, 5, -10), vec3(0.001f, 0, 0), vec3(-0.0001f, 0, 0), triObject, "triangle"));

	RenderObject ballObject(ballMesh, shader);
	g->addEntity(new Entity(vec3(1, 10, -10), vec3(0.001f, 0, 0), vec3(-0.0001f, 0, 0), ballObject, "cueball"));
