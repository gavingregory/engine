...
int main()
{
	...
	g->addEntity(new Entity(vec3(1, 10, -10), vec3(0.001f, 0, 0), vec3(-0.0001f, 0, 0), triObject));

	RenderObject ballObject(ballMesh, shader);
	g->addEntity((Entity*)new Ball(vec3(1, 5, -10), vec3(0.001f, 0, 0), vec3(-0.0001f, 0, 0), ballObject));
